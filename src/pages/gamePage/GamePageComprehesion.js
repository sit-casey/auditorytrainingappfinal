...
function GamePageComprehension() {
    ...
    <>
      ...
      <div>
        <div className={classes.header}>
          <h1>Comprehension Games</h1>
          <p>Please select your game!</p>
        </div>
        <div
          style={{ margin: "20px 0", fontSize: "18px", textAlign: "center" }}
        >
          <p>You have completed {completedLevels.length} out of 3 levels.</p>
        </div>
        <div
        ...
        <div className={classes.buttonlayout}>
          <div className={classes.allComprehensionGames}>
            <GameOptions optionsArr={allComprehensionGames.comprehension} />
          </div>
        </div>
      </div>
    </>
...
export default GamePageComprehension;